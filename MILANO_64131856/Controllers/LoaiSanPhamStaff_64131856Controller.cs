...
{
    public class LoaiSanPhamStaff_64131856Controller : Controller
    {
        private MILANO_64131856Entities db = new MILANO_64131856Entities();

        // GET: LoaiSanPhamStaff_64131856
        public ActionResult Index()
        {
            return View(db.LoaiSanPhams.ToList());
        }

        // GET: LoaiSanPhamStaff_64131856/Details/5
        ...
        // GET: LoaiSanPhamStaff_64131856/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: LoaiSanPhamStaff_64131856/Create
        ...
        // GET: LoaiSanPhamStaff_64131856/Edit/5
        ...
        // POST: LoaiSanPhamStaff_64131856/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: LoaiSanPhamStaff_64131856/Delete/5
        ...
        // POST: LoaiSanPhamStaff_64131856/Delete/5
        ...
        //tim kiem loai sp
        public ActionResult TimKiemLoaiSanPhamStaff_64131856(string maLoai = "", string tenLoai = "")
        {
