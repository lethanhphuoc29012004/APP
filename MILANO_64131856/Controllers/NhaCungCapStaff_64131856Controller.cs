...
{
    public class NhaCungCapStaff_64131856Controller : Controller
    {
        private MILANO_64131856Entities db = new MILANO_64131856Entities();

        // GET: NhaCungCapStaff_64131856
        public ActionResult Index()
        {
            return View(db.NhaCungCaps.ToList());
        }
        //timkiem nha cung cap
        public ActionResult TimKiem_NhaCungCapStaff_64131856(string maNCC = "", string tenNCC = "")
        {
            ViewBag.maNCC = maNCC;
        ...
        // GET: NhaCungCapStaff_64131856/Details/5
        ...
        // GET: NhaCungCapStaff_64131856/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NhaCungCapStaff_64131856/Create
        ...
        // GET: NhaCungCapStaff_64131856/Edit/5
        ...
        // POST: NhaCungCapStaff_64131856/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: NhaCungCapStaff_64131856/Delete/5
        ...
        // POST: NhaCungCapStaff_64131856/Delete/5
