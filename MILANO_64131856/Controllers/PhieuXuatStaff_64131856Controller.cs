...
{
    public class PhieuXuatStaff_64131856Controller : Controller
    {
        private MILANO_64131856Entities db = new MILANO_64131856Entities();

        // GET: PhieuXuatStaff_64131856
        public ActionResult Index()
        {
            return View(db.PhieuXuats.ToList());
        }

        // GET: PhieuXuatStaff_64131856/Details/5
        ...
        // GET: PhieuXuatStaff_64131856/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: PhieuXuatStaff_64131856/Create
        ...
        // GET: PhieuXuatStaff_64131856/Edit/5
        ...
        // POST: PhieuXuatStaff_64131856/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PhieuXuatStaff_64131856/Delete/5
        ...
        // POST: PhieuXuatStaff_64131856/Delete/5
